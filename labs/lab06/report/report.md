...
author: "Гаглоев Олег НПИбд-01-20"
...
![Запуск сервера 1](../img/3.png)

![Запуск сервера 2](../img/4.png)
...
![Просмотр состояний переключателей](../img/6.png)

5. Посмотрите статистику по политике с помощью команды seinfo, также определите множество пользователей, ролей, типов.

![Статистика seinfo](../img/7.png)
...
![Работа с файлом](../img/11.png)

![Работа с файлом](../img/12.png)
...
![Анализ логов](../img/14.png)

![Анализ логов](../img/15.png)
...
![Лог файлы](../img/18.png)

![Лог файлы](../img/19.png)
...
![Выполнение команды](../img/20.png)

20.    Попробуйте запустить веб-сервер Apache ещё раз.

![Запуск сервера](../img/21.png)
