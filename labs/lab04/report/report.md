...
![Установка атрибута ](../img/3.png){ #fig:003 width=70% height=70%}
...
![Установка атрибута от имени администратора](../img/4.png){ #fig:004 width=70% height=70%}
...
![Проверка атрибута](../img/5.png){#fig:005 width=70% height=70%}

6. Выполните дозапись в файл file1 слова «test» командой echo "test" >> /home/guest/dir1/file1

![Дозапись](../img/6.png){#fig:006 width=70% height=70%}
...
![Операции с файлом](../img/8.png){ #fig:008 width=70% height=70%}
...
![Снятие атрибутов](../img/9.png){ #fig:009 width=70% height=70%}
...
![Снятие атрибута](../img/10.png){ #fig:010 width=70% height=70%}

![Снятие атрибута](../img/10.2.png){ #fig:011 width=70% height=70%}

Атрибут снят.

Повторите операции, которые вам ранее не удавалось выполнить. Ваши наблюдения занесите в отчёт.

![Повторение действий](../img/11.png){ #fig:012 width=70% height=70%}
...
![Установка атрибута i](../img/12.png){ #fig:013 width=70% height=70%}

![Проверка атрибута i](../img/13.png){ #fig:014 width=70% height=70%}

![Действия](../img/14.png){ #fig:015 width=70% height=70%}
